...
class JSQLHibernateStatementParserTest {
    ...
    public void _parseSqlStatement_select() {
        ...
        verify(hibernateStatementCountListener, description("the correct notifier is called")).notifySelectStatement();
    }
    ...
    public void _parseSqlStatement_update() {
        ...
        verify(hibernateStatementCountListener, description("the correct notifier is called")).notifyUpdateStatement();
    }
    ...
    public void _parseSqlStatement_insert() {
        ...
        verify(hibernateStatementCountListener, description("the correct notifier is called")).notifyInsertStatement();
    }
    ...
    public void _parseSqlStatement_delete() {
        ...
        verify(hibernateStatementCountListener, description("the correct notifier is called")).notifyDeleteStatement();
    }
}
